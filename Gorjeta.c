...
double gorjeta_pequena(double x) {      //Triangular centrada em 0
    if (x <= 0) return 1.0;
    else if (x < 5) return (5.0 - x) / 5.0;
    else return 0.0;
}

double gorjeta_media(double x) {        //Triangular centrada em 10
    if (x >= 5 && x <= 10) return (x - 5.0) / 5.0;
    else if (x > 10 && x <= 15) return (15.0 - x) / 5.0;
    else return 0.0;
}

double gorjeta_alta(double x) {         //Triangular centrada em 20
    if (x >= 15 && x <= 20) return (x - 15.0) / 5.0;
